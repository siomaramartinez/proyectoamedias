...
class CreateGrupobsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('grupobs', function (Blueprint $table) {
            ...
            $table->timestamp("Juego")->nullable($value = true);
